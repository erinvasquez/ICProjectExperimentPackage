...
public abstract class Menu<T> : Menu where T : Menu<T> {
    ...
    protected static void Open() {
        if (Instance == null) {
            ...
            if (EXP_MenuManager.Instance != null) {
                EXP_MenuManager.Instance.CreateInstance<T>();
            }
        ...
        Debug.Log($"Opening {typeof(T)} menu");

        if (EXP_MenuManager.Instance != null) {
            EXP_MenuManager.Instance.OpenMenu(Instance);
        }
    ...
    protected static void Close() {
        ...
        Debug.Log($"Closing {typeof(T)} menu");

        if (EXP_MenuManager.Instance != null) {
            EXP_MenuManager.Instance.CloseMenu(Instance);
        }
