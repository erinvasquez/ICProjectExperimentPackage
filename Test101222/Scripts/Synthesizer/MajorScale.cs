...
public class MajorScale : Scale {
    ...
    /// <summary>
    /// Returns either tonic, third, or fifth or the current scale
    /// </summary>
    /// <returns></returns>
    public MusicNote GetRandomMajorTriadNote() {

        MusicNote[] triad = GetMajorTriad();
        return triad[Random.Range(0, triad.Length)];
